...
err_max = 0;
err_rms = 0;
[t,Y,ns] = solve_DIRK('fbruss1', 'Jbruss1', tout, Y0, B, h);
for j=1:3
...
err_max = 0;
err_rms = 0;
[t,Y,ns] = solve_DIRK('fbruss2', 'Jbruss2', tout, Y0, B, h);
for j=1:3
   diff = (Y(j,end) - Ytrue(j))/Ytrue(j);
   err_max = max([err_max, abs(diff)]);
   err_rms = err_rms + diff^2;
...
err_max = 0;
err_rms = 0;
[t,Y,ns] = solve_DIRK('fbruss3', 'Jbruss3', tout, Y0, B, h);
for j=1:3
   diff = (Y(j,end) - Ytrue(j))/Ytrue(j);
   err_max = max([err_max, abs(diff)]);
   err_rms = err_rms + diff^2;
...
[t,Y,ns] = solve_DIRK('fbruss1', 'Jbruss1', tout, Y0, B, h);
tout = [0,10];
[t,Y,ns2] = solve_DIRK('fbruss1', 'Jbruss1', tout, Y0, B, h);
tout = [0,50];
[t,Y,ns3] = solve_DIRK('fbruss1', 'Jbruss1', tout, Y0, B, h);
tf = cputime;
...
[t,Y,ns] = solve_DIRK('fbruss2', 'Jbruss2', tout, Y0, B, h);
tout = [0,10];
[t,Y,ns2] = solve_DIRK('fbruss2', 'Jbruss2', tout, Y0, B, h);
tout = [0,50];
[t,Y,ns3] = solve_DIRK('fbruss2', 'Jbruss2', tout, Y0, B, h);
tf = cputime;
...
[t,Y,ns] = solve_DIRK('fbruss3', 'Jbruss3', tout, Y0, B, h);
tout = [0,10];
[t,Y,ns2] = solve_DIRK('fbruss3', 'Jbruss3', tout, Y0, B, h);
tout = [0,50];
[t,Y,ns3] = solve_DIRK('fbruss3', 'Jbruss3', tout, Y0, B, h);
tf = cputime;

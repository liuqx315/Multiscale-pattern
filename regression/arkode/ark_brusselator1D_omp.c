...
int main()
{
  ...
  ytrue = N_VNew_OpenMP(NEQ, num_threads);
  if (check_flag((void *) ytrue, "N_VNew_OpenMP", 0)) return 1;
  yerr = N_VNew_OpenMP(NEQ, num_threads);
  if (check_flag((void *) yerr, "N_VNew_OpenMP", 0)) return 1;
  ...
  umask = N_VNew_OpenMP(NEQ, num_threads);
  ...
  /* Free vectors */
  N_VDestroy_OpenMP(y);
  N_VDestroy_OpenMP(ytrue);
  N_VDestroy_OpenMP(yerr);

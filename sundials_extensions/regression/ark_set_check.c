 ...
 * 
 * Runs through all possible "set" routines in ARKODE to see whether 
 * the relevant parameters get set appropriately within ark_mem.
 * -----------------------------------------------------------------*/
...
#include <arkode/arkode_impl.h>      /* internal arkode structures */
...
static int hfun(N_Vector y, realtype t, realtype h, realtype e1, realtype e2, 
		realtype e3, int q, int p, realtype *hnew, void *user_data);

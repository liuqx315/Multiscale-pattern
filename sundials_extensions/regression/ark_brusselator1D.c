...
#include <arkode/arkode_spgmr.h>     /* prototype for ARKSpgmr */
#include <arkode/arkode_spbcgs.h>    /* prototype for ARKSpbcg */
#include <arkode/arkode_sptfqmr.h>   /* prototype for ARKSptfqmr */

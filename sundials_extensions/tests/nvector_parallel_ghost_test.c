...
int main(int argc, char *argv[]) 
{
  ...
  printf("2D test, Fortran order\n");
  ndim = 2;
  dim_len[0]  = 10;  dim_len[1]  = 10;
  dim_alen[0] = 13;  dim_alen[1] = 10;
  ...
  /* 2D tests, C order */
  printf("2D test, C order\n");
  ndim = 2;
  dim_len[0]  = 8;   dim_len[1]  = 12;
  dim_alen[0] = 13;  dim_alen[1] = 15;
  ...
  printf("3D test, Fortran order\n");
  ndim = 3;
  dim_len[0]  = 5;  dim_len[1]  = 4;  dim_len[2]  = 3;
  dim_alen[0] = 8;  dim_alen[1] = 9;  dim_alen[2] = 4;
  ...
  /* 3D tests, C order */
  printf("3D test, C order\n");
  ndim = 3;
  dim_len[0]  = 4;  dim_len[1]  = 3;  dim_len[2]  = 5;
  dim_alen[0] = 9;  dim_alen[1] = 5;  dim_alen[2] = 8;
  ...
  printf("4D test, Fortran order\n");
  ndim = 4;
  dim_len[0]  = 3;  dim_len[1]  = 4;  dim_len[2]  = 6;  dim_len[3]  = 4;
  dim_alen[0] = 7;  dim_alen[1] = 9;  dim_alen[2] = 9;  dim_alen[3] = 7;
  ...
  /* 4D tests, C order */
  printf("4D test, C order\n");
  ndim = 4;
  dim_len[0]  = 4;  dim_len[1]  = 3;  dim_len[2]  = 4;  dim_len[3]  = 6;
  dim_alen[0] = 7;  dim_alen[1] = 7;  dim_alen[2] = 9;  dim_alen[3] = 9;
  ...
  printf("5D test, Fortran order\n");
  ndim = 5;
  dim_len[0]  = 3;  dim_len[1]  = 4;  dim_len[2]  = 6;  
  dim_len[3]  = 4;  dim_len[4]  = 6;
  dim_alen[0] = 7;  dim_alen[1] = 9;  dim_alen[2] = 9;  
  dim_alen[3] = 7;  dim_alen[4] = 9;
  ...
  /* 5D tests, C order */
  printf("5D test, C order\n");
  ndim = 5;
  dim_len[0]  = 4;  dim_len[1]  = 3;  dim_len[2]  = 4;  
  dim_len[3]  = 6;  dim_len[4]  = 4;
  dim_alen[0] = 7;  dim_alen[1] = 7;  dim_alen[2] = 9;  
  dim_alen[3] = 9;  dim_alen[4] = 7;
  ...
  printf("6D test, Fortran order\n");
  ndim = 6;
  dim_len[0]  = 3;  dim_len[1]  = 4;  dim_len[2]  = 6;  
  dim_len[3]  = 4;  dim_len[4]  = 6;  dim_len[4]  = 2;
  dim_alen[0] = 7;  dim_alen[1] = 9;  dim_alen[2] = 9;  
  dim_alen[3] = 7;  dim_alen[4] = 9;  dim_alen[4] = 5;
  dim_off[0]  = 2;  dim_off[1]  = 2;  dim_off[2]  = 1;  
  dim_off[3]  = 1;  dim_off[4]  = 0;  dim_off[4]  = 2;
  Forder = 1;
  test_fails = tester(comm, ndim, dim_len, dim_alen, dim_off, Forder);
  if (test_fails) {
  ...
  /* 6D tests, C order */
  printf("6D test, C order\n");
  ndim = 6;
  dim_len[0]  = 4;  dim_len[1]  = 3;  dim_len[2]  = 4;  
  dim_len[3]  = 6;  dim_len[4]  = 4;  dim_len[4]  = 6;
  dim_alen[0] = 7;  dim_alen[1] = 7;  dim_alen[2] = 9;  
  dim_alen[3] = 9;  dim_alen[4] = 7;  dim_alen[4] = 6;
  dim_off[0]  = 1;  dim_off[1]  = 2;  dim_off[2]  = 2;  
  dim_off[3]  = 1;  dim_off[4]  = 2;  dim_off[4]  = 0;
  Forder = 0;
  test_fails = tester(comm, ndim, dim_len, dim_alen, dim_off, Forder);
  if (test_fails) {

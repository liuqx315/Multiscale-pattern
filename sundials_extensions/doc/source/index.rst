...
This is the documentation site for ARKode, an adaptive step time
...
ARKode development is supported by the `US Department of Energy
...
Welcome to ARKode's documentation!
==================================

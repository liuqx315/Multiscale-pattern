...
/*---------------------------------------------------------------
 ...
 with a *):
  ...
  ----------------------------------------------------
    ...
    23*   Sayfy-Aburub-4-3  EDIRK   6   4   3   X   - 
    24    Ismail(7,4,5)    ESDIRK   7   5   4   -   - 
			   ...
			   realtype *c, realtype *b2) 
{
  ...
  for (i=0; i<ARK_S_MAX; i++) {
    ...
    c[i]  = ZERO;
    b2[i] = ZERO;
    for (j=0; j<ARK_S_MAX; j++)  A[i][j]  = ZERO;
  }
  ...
  case(15):    /* Kvaerno(4,2,3)-ESDIRK */
    ...
    *q = 3;
    *p = 2;
    A[1][0] = RCONST(0.4358665215);
    A[1][1] = RCONST(0.4358665215);
    A[2][0] = RCONST(0.490563388419108);
    A[2][1] = RCONST(0.073570090080892);
    A[2][2] = RCONST(0.4358665215);
    A[3][0] = RCONST(0.308809969973036);
    A[3][1] = RCONST(1.490563388254106);
    A[3][2] = RCONST(-1.235239879727145);
    A[3][3] = RCONST(0.4358665215);
  ...
  case(16):    /* ARK3(2)4L[2]SA-ESDIRK */
    ...
    *q = 3;
    *p = 2;
    A[1][0] = RCONST(1767732205903.0)/RCONST(4055673282236.0);
    A[1][1] = RCONST(1767732205903.0)/RCONST(4055673282236.0);
    A[2][0] = RCONST(2746238789719.0)/RCONST(10658868560708.0);
    A[2][1] = RCONST(-640167445237.0)/RCONST(6845629431997.0);
    A[2][2] = RCONST(1767732205903.0)/RCONST(4055673282236.0);
    A[3][0] = RCONST(1471266399579.0)/RCONST(7840856788654.0);
    A[3][1] = RCONST(-4482444167858.0)/RCONST(7529755066697.0);
    A[3][2] = RCONST(11266239266428.0)/RCONST(11593286722821.0);
    A[3][3] = RCONST(1767732205903.0)/RCONST(4055673282236.0);
  ...
  case(21):    /* Kvaerno(5,3,4)-ESDIRK */
    ...
    *p = 3;
    A[1][0] = RCONST(0.4358665215); 
    A[1][1] = RCONST(0.4358665215); 
    A[2][0] = RCONST(0.140737774731968);
    A[2][1] = RCONST(-0.108365551378832);
    A[2][2] = RCONST(0.4358665215);
    A[3][0] = RCONST(0.102399400616089);
    A[3][1] = RCONST(-0.376878452267324);
    A[3][2] = RCONST(0.838612530151233);
    A[3][3] = RCONST(0.4358665215);
    A[4][0] = RCONST(0.157024897860995);
    A[4][1] = RCONST(0.117330441357768);
    A[4][2] = RCONST(0.61667803039168);
    A[4][3] = RCONST(-0.326899891110444);
    A[4][4] = RCONST(0.4358665215);
  ...
  case(25):    /* Kvaerno(7,4,5)-ESDIRK */
    ...
    *p = 4;
    ...
    A[1][1] = RCONST(0.26);
    A[2][0] = RCONST(0.13);
    A[2][1] = RCONST(0.84033320996790809);
    A[2][2] = RCONST(0.26);
    A[3][0] = RCONST(0.22371961478320505);
    A[3][1] = RCONST(0.47675532319799699);
    A[3][2] = RCONST(-0.06470895363112615);
    A[3][3] = RCONST(0.26);
    A[4][0] = RCONST(0.16648564323248321);
    A[4][1] = RCONST(0.10450018841591720);
    A[4][2] = RCONST(0.03631482272098715);
    A[4][3] = RCONST(-0.13090704451073998);
    A[4][4] = RCONST(0.26);
    A[5][0] = RCONST(0.13855640231268224);
    A[5][2] = RCONST(-0.04245337201752043);
    A[5][3] = RCONST(0.02446657898003141);
    A[5][4] = RCONST(0.61943039072480676);
    A[5][5] = RCONST(0.26);
    A[6][0] = RCONST(0.13659751177640291);
    A[6][2] = RCONST(-0.05496908796538376);
    A[6][3] = RCONST(-0.04118626728321046);
    A[6][4] = RCONST(0.62993304899016403);
    A[6][5] = RCONST(0.06962479448202728);
    A[6][6] = RCONST(0.26);

...
SUNDIALS_EXPORT int ARKBandPrecInit(void *arkode_mem, long int N, long int mu, long int ml);
...
SUNDIALS_EXPORT int ARKBandPrecGetWorkSpace(void *arkode_mem, long int *lenrwLS, long int *leniwLS);
SUNDIALS_EXPORT int ARKBandPrecGetNumRhsEvals(void *arkode_mem, long int *nfevalsBP);

...
typedef struct ARKodeMemRec {
  ...
  int ark_qmax;          /* q <= qmax                                          */
  long int ark_mxstep;   /* maximum number of internal steps for one user call */
  int ark_maxcor;        /* maximum number of corrector iterations for the
                           solution of the nonlinear equation                 */
  int ark_mxhnil;        /* maximum number of warning messages issued to the
                           user that t + h == t for the next internal step    */
  int ark_maxnef;        /* maximum number of error test failures              */
  int ark_maxncf;        /* maximum number of nonlinear convergence failures   */
  ...
  int ark_mxgnull;          /* number of warning messages about possible g==0  */
 ...
 *
 * ARK_NO_FAILURES : Either this is the first ark_setup call for this
 ...
 * ARKODE linear solver and a negative value otherwise.
...
/*
 * -----------------------------------------------------------------
 * int (*ark_lsetup)(ARKodeMem ark_mem, int convfail, N_Vector ypred,

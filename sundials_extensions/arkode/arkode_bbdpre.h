...
-----------------------------------------------------------------
 ...
 ARKSPTFQMR, and the parallel implementation of the NVECTOR 
 module.
...
/*---------------------------------------------------------------
 ...
 ARKSPBCG/ARKBBDPRE or ARKSPTFQMR/ARKBBDPRE provided there is no 
 change in Nlocal, mukeep, or mlkeep. After solving one problem, 
 and after calling ARKodeReInit to re-initialize the integrator 
 for a subsequent problem, call ARKBBDPrecReInit.

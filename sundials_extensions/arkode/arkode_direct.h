...
/*
 * =================================================================
 *              A R K D I R E C T     C O N S T A N T S
 * =================================================================
 */
...
typedef int (*ARKDlsBandJacFn)(long int N, long int mupper, long int mlower,
...
SUNDIALS_EXPORT int ARKDlsSetDenseJacFn(void *arkode_mem, ARKDlsDenseJacFn jac);
SUNDIALS_EXPORT int ARKDlsSetBandJacFn(void *arkode_mem, ARKDlsBandJacFn jac);
...
SUNDIALS_EXPORT int ARKDlsGetWorkSpace(void *arkode_mem, long int *lenrwLS, long int *leniwLS);
SUNDIALS_EXPORT int ARKDlsGetNumJacEvals(void *arkode_mem, long int *njevals);
SUNDIALS_EXPORT int ARKDlsGetNumRhsEvals(void *arkode_mem, long int *nfevalsLS);
SUNDIALS_EXPORT int ARKDlsGetLastFlag(void *arkode_mem, long int *flag);

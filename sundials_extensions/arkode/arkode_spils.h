...
typedef int (*ARKSpilsPrecSetupFn)(realtype t, N_Vector y, N_Vector fy,
...
typedef int (*ARKSpilsPrecSolveFn)(realtype t, N_Vector y, N_Vector fy,
...
typedef int (*ARKSpilsJacTimesVecFn)(N_Vector v, N_Vector Jv, realtype t,
 ...
 *
 * ARKSpilsSetPreconditioner specifies the PrecSetup and PrecSolve functions.
 *                Default is NULL for both arguments (no preconditioning)
 *
 * ARKSpilsSetJacTimesVecFn specifies the jtimes function. Default is to 
...
SUNDIALS_EXPORT int ARKSpilsGetWorkSpace(void *arkode_mem, long int *lenrwLS, long int *leniwLS);
SUNDIALS_EXPORT int ARKSpilsGetNumPrecEvals(void *arkode_mem, long int *npevals);
SUNDIALS_EXPORT int ARKSpilsGetNumPrecSolves(void *arkode_mem, long int *npsolves);
SUNDIALS_EXPORT int ARKSpilsGetNumLinIters(void *arkode_mem, long int *nliters);
SUNDIALS_EXPORT int ARKSpilsGetNumConvFails(void *arkode_mem, long int *nlcfails);
SUNDIALS_EXPORT int ARKSpilsGetNumJtimesEvals(void *arkode_mem, long int *njvevals);
SUNDIALS_EXPORT int ARKSpilsGetNumRhsEvals(void *arkode_mem, long int *nfevalsLS); 
SUNDIALS_EXPORT int ARKSpilsGetLastFlag(void *arkode_mem, long int *flag);
